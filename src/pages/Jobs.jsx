...
const Jobs = () => {
  ...
  const [josDataArray, setjosDataArray] = useState(jobsMainData);
  ...
  useEffect(() => {
    switch (sortlist) {
      case 0:
        {
          let cpyArray = [...jobsMainData];
          cpyArray.sort((a, b) => b.candidates.total - a.candidates.total);
      ...
      case 1:
        {
          let cpyArray = [...jobsMainData];
          cpyArray.sort((a, b) => a.candidates.total - b.candidates.total);
          setjosDataArray(cpyArray);
        }
        break;
      case 2:
  ...
  useEffect(() => {
    switch (status) {
      case 0:
        setjosDataArray(jobsMainData);
        break;
      case 1:
        {
          let cpyArray = jobsMainData.filter(
      ...
      case 2:
        {
          let cpyArray = jobsMainData.filter((job) => job.status === "Draft");
          setjosDataArray([...cpyArray]);
        }
        break;
    ...
    <div className="bg-gray-200 py-2">
      ...
      <div className="py-4 px-6">
        ...
        <div className="grid place-items-center">
            <button onClick={()=>navigate("/new-job")} className="grid place-items-center bg-green-800 shadow-md px-6 py-2 text-white rounded-md text-sm">Create New Job</button>
          </div>
        </div>
        <div className="px-4 pt-6 grid grid-cols-4 gap-y-6 place-items-center">
          {josDataArray.map((job) => (
            <div
              key={job.id}
            ...
            >
              ...
              <div className="flex justify-between px-2 mt-8 py-1 border-t">
                ...
                <div
                  onClick={() => navigate("/job-detailed", { state: { job } })}

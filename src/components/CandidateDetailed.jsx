    ...
    >
      ...
      >
        ...
        <div className={`${tabs === 3 ? "" : "hidden"}`}>
          ...
          >
            <div className="m-4 bg-blue-500 text-white p-4 max-w-max rounded-md">
                ...
                <div className="py-2 flex">
                  {!updateBtn ? (
                    <button
                      ...
                      className=" justify-end font-bold text-sm text-white bg-green-800 px-6 py-2 rounded-md"
                    >
                      Schedule
                    </button>
                  ) : (
                    <button
                      onClick={() => updateCurrInterview()}
                      className=" justify-end font-bold text-sm text-white bg-green-800 px-6 py-2 rounded-md"
                    >
                      Update Interview
                    </button>
